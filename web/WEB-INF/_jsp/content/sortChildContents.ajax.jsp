...
<%
    ...
    String url = "/ajax/" + contentData.getTypeKey() + "/saveChildPageRanking/" + contentData.getId();%>
        ...
        <form:form url="<%=url%>" name="pageform" ajax="true" multi="true">
            <div class="modal-body">
                ...
                <%
                    ...
                    for (ContentData subpage : contentContainer().getContent(contentData.getId()).getChildren()) {
