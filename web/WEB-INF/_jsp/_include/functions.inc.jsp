...
--%>
<%@ page import="de.elbe5.base.data.StringUtil" %>
<%@ page import="java.time.LocalDateTime" %>
<%@ page import="de.elbe5.application.Strings" %>
<%@ page import="java.util.Locale" %>
<%@ page import="java.time.LocalDate" %>
<%@ page import="java.time.LocalTime" %>
<%@ page import="de.elbe5.application.Application" %>
<%@ page import="de.elbe5.application.Configuration" %>
<%@ page import="de.elbe5.user.UserContainer" %>
<%@ page import="de.elbe5.content.ContentContainer" %>
<%!
